...
class BNO08x
{
    ...
    private:
        ...
        static const constexpr TickType_t POST_RESET_SETTLE_MS =
                CONFIG_ESP32_BNO08X_POST_RESET_SETTLE_MS /
                portTICK_PERIOD_MS; ///<How long to wait after releasing reset before allowing the next SPI transaction.
